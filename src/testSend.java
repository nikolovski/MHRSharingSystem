...
public class testSend {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.print("Enter the email you want to sendEMail the record to: ");
            email = in.next();
            allFunctions.defaultConfiguration();
            allFunctions.setPatientID(id);
            allFunctions.setPatientFirstName(firstName);
            allFunctions.setPatientLastName(lastName);
            allFunctions.sendEMail(email,"Medical Health Record", allFunctions.getFileName());
            in.close();
